        ...
        <div class="mt-12">
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="mt-8 border-t border-gray-200 pt-8">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="text-sm text-gray-900">Status: Paid</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-4 py-4 bg-gray-50 sm:px-6">
                    <div class="flex justify-between">
                        <a href="?page=orders" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                            View All Orders
                        </a>
