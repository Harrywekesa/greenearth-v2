        ...
        <div class="px-4 md:px-10 py-8">
            <div class="max-w-7xl mx-auto">
                <div class="flex justify-between items-center">
                    ...
                    <a href="?page=admin/initiatives/create" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900"><?php echo htmlspecialchars($initiative['title']); ?></div>
                                                <div class="text-sm text-gray-500"><?php echo substr(htmlspecialchars($initiative['description']), 0, 50); ?>...</div>
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="?page=admin/initiatives/edit&id=<?php echo $initiative['id']; ?>" class="text-green-600 hover:text-green-900">Edit</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
