...
if($zone_id > 0) {
    ...
    if(!$zone) {
        header("Location: ?page=admin/zones/list");
        exit;
    }
} else {
    header("Location: ?page=admin/zones/list");
    ...
    if($_FILES['csv_file']['error'] === UPLOAD_ERR_OK) {
        ...
        if($handle) {
            ...
            if($stmt->execute()) {
                ...
                $error = "Error importing data: " . $stmt->error;
            }
        } else {
        ...
        <div class="px-4 md:px-10 py-8">
            <div class="max-w-3xl mx-auto">
                <div class="flex justify-between items-center">
                    <h1 class="text-2xl font-bold text-gray-900">Import Climate Data for <?php echo $zone['name']; ?></h1>
                ...
                <div class="mt-6 bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Upload a CSV file with climate data for this zone. The file should contain monthly data with the following columns:
                        </p>
                ...
                <div class="mt-6 bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                    <h2 class="text-lg font-medium text-gray-900">Sample CSV Format</h2>
