...
<head>
    ...
    <style>
        ...
        /* Fixed header should be above sidebar */
        .fixed-header {
            position: fixed;
            top: 0;
            left: 0;
            right: 0;
            z-index: 30; /* Higher than sidebar */
        }
    </style>
</head>
<body class="bg-gray-100">
    ...
    <!-- Sidebar -->
    <div class="sidebar">
        <div class="flex flex-col h-full pt-16"> <!-- pt-16 to account for header -->
        ...
        <div class="px-4 md:px-10 py-8">
            <div class="max-w-7xl mx-auto">
                <div class="flex justify-between items-center">
                    ...
                    <a href="?page=admin/zones/create" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="?page=admin/zones/edit&id=<?php echo $zone['id']; ?>" class="text-green-600 hover:text-green-900">Edit</a>
                                                <a href="?page=admin/zones/import&id=<?php echo $zone['id']; ?>" class="ml-4 text-blue-600 hover:text-blue-900">Import Data</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
