...
// Get all users
$stmt = $connection->prepare("SELECT * FROM users ORDER BY name");
$stmt->execute();
...
<head>
    ...
    <title>Manage Users - GreenEarth Admin</title>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 h-10 w-10 bg-gray-200 rounded-full flex items-center justify-center">
                                                        <span class="text-gray-500 text-sm"><?php echo substr($user['name'], 0, 1); ?></span>
                                                    </div>
                                                    <div class="ml-4">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo htmlspecialchars($user['county']); ?>, <?php echo htmlspecialchars($user['subcounty']); ?>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                    ...
                                                    switch($user['role']) {
                                                        ...
                                                        case 'partner': echo 'bg-blue-100 text-blue-800'; break;
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="?page=admin/users/edit&id=<?php echo $user['id']; ?>" class="text-green-600 hover:text-green-900">Edit</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
