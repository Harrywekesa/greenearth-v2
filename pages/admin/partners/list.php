...
// Get all partners
$stmt = $connection->prepare("SELECT * FROM partners ORDER BY name");
$stmt->execute();
...
<head>
    ...
    <title>Manage Partners - GreenEarth Admin</title>
        ...
        <div class="px-4 md:px-10 py-8">
            <div class="max-w-7xl mx-auto">
                <div class="flex justify-between items-center">
                    ...
                    <a href="?page=admin/partners/create" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="flex-shrink-0 h-10 w-10">
                                                        <img class="h-10 w-10 rounded-full" src="../../../uploads/partners/<?php echo $partner['logo']; ?>" alt="<?php echo htmlspecialchars($partner['name']); ?>">
                                                    </div>
                                                    <?php else: ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900"><?php echo htmlspecialchars($partner['email']); ?></div>
                                                <div class="text-sm text-gray-500"><?php echo htmlspecialchars($partner['phone']); ?></div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                    <?php 
                                                    switch($partner['sponsorship_level']) {
                                                        ...
                                                        case 'bronze': echo 'bg-amber-100 text-amber-800'; break;
                                                    }
                                                    ?>">
                                                    <?php echo ucfirst($partner['sponsorship_level']); ?>
                                                </span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="?page=admin/partners/edit&id=<?php echo $partner['id']; ?>" class="text-green-600 hover:text-green-900">Edit</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
