...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($stmt->execute()) {
        ...
        header("Location: ?page=admin/events/list&message=" . urlencode($message));
        exit;
    } else {
...
<head>
    ...
    <title>Create Event - GreenEarth Admin</title>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <input type="number" name="max_volunteers" id="max_volunteers" min="1" value="50" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm">
                            </div>
