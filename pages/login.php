...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Check credentials
    $stmt = $connection->prepare("SELECT id, name, email, phone, password, county, subcounty, role, is_active FROM users WHERE email = ?");
        ...
        if($user['is_active']) {
            ...
            if(password_verify($password, $user['password'])) {
                ...
                if($user['role'] === 'admin') {
                    ...
                    $_SESSION['admin_county'] = $user['county'];
                    $_SESSION['admin_subcounty'] = $user['subcounty'];
                    ...
                    $_SESSION['user_county'] = $user['county'];
                    $_SESSION['user_subcounty'] = $user['subcounty'];
        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Or <a href="?page=register<?php echo isset($_GET['redirect']) ? '&redirect=' . urlencode($_GET['redirect']) : ''; ?>" class="font-medium text-green-600 hover:text-green-500">
            ...
            <div class="mt-8 bg-white shadow rounded-lg p-6">
                <form class="mt-8 space-y-6" method="POST">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input id="remember_me" name="remember_me" type="checkbox" class="focus:ring-green-500 h-4 w-4 text-green-600 border-gray-300 rounded">
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="?page=register<?php echo isset($_GET['redirect']) ? '&redirect=' . urlencode($_GET['redirect']) : ''; ?>" class="font-medium text-green-600 hover:text-green-500">
                            Register here
                        </a>
                    </p>
                </div>
