...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['csv_file'])) {
    if($_FILES['csv_file']['error'] === UPLOAD_ERR_OK) {
        ...
        if($handle) {
            ...
            $stmt = $connection->prepare("UPDATE initiatives SET historical_data = ? WHERE id = ?");
            $stmt->bind_param("si", $json_data, $initiative_id);
            
            if($stmt->execute()) {
                $message = "Initiative data imported successfully!";
                ...
                $error = "Error importing initiative data: " . $stmt->error;
            }
        } else {
...
<head>
    ...
    <title>Import Initiative Data - GreenEarth Admin</title>
            ...
            <div class="px-4 md:px-10 py-8">
                <div class="max-w-4xl mx-auto">
                    <div class="flex justify-between items-center">
                        <h1 class="text-2xl font-bold text-gray-900">Import Data for <?php echo htmlspecialchars($initiative['title']); ?></h1>
                    ...
                    <div class="mt-6">
                        <div class="bg-white rounded-lg shadow p-6">
                            <h2 class="text-lg font-medium text-gray-900">Upload Initiative Data</h2>
                            <div class="mt-4">
                                <p class="text-sm text-gray-500">
                                    Upload a CSV file with historical data for <?php echo htmlspecialchars($initiative['title']); ?> initiative.
                                </p>
                            </div>
                        ...
                        <?php if($initiative['historical_data']): ?>
                        <div class="mt-8 bg-white rounded-lg shadow p-6">
                            <h2 class="text-lg font-medium text-gray-900">Current Data</h2>
                            <div class="mt-4">
                                <p class="text-sm text-gray-500">
                                    This initiative currently has <?php echo count(json_decode($initiative['historical_data'], true)); ?> records of historical data.
                                </p>
                            </div>
