...
// Get all initiatives with partner info
...
<head>
    ...
    <title>Manage Initiatives - GreenEarth Admin</title>
            ...
            <div class="px-4 md:px-10 py-8">
                <div class="max-w-7xl mx-auto">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="?page=initiatives/create" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="flex-shrink-0 h-10 w-10">
                                                            <img class="h-10 w-10 rounded-md object-cover" src="uploads/initiatives/<?php echo $initiative['image']; ?>" alt="<?php echo htmlspecialchars($initiative['title']); ?>">
                                                        </div>
                                                        <?php else: ?>
                                                        ...
                                                        <div class="ml-4">
                                                            ...
                                                            <div class="text-sm text-gray-500">
                                                                <?php echo substr(htmlspecialchars($initiative['description']), 0, 50); ?>...
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        ...
                                                        <span class="ml-2 text-sm text-gray-500">
                                                            <?php echo number_format($initiative['planted_trees']); ?>/<?php echo number_format($initiative['target_trees']); ?>
                                                        </span>
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <a href="?page=initiatives/edit&id=<?php echo $initiative['id']; ?>" class="text-green-600 hover:text-green-900">Edit</a>
                                                    <a href="?page=initiatives/import&id=<?php echo $initiative['id']; ?>" class="ml-4 text-blue-600 hover:text-blue-900">Import Data</a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
