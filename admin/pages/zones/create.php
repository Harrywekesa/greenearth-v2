...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($stmt->execute()) {
        $message = "Climatic zone created successfully!";
        header("Location: ?page=pages/zones/list&message=" . urlencode($message));
        exit;
    } else {
        $error = "Error creating climatic zone: " . $stmt->error;
    }
}
?>
            ...
            <div class="px-4 md:px-10 py-8">
                <div class="max-w-3xl mx-auto">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="?page=pages/zones/list" class="text-sm font-medium text-green-600 hover:text-green-500">
                            ← Back to zones
                        </a>
                    </div>
