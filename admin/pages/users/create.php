...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($result->num_rows > 0) {
        ...
        if($stmt->execute()) {
            ...
            header("Location: ?page=users/list&message=" . urlencode($message));
            exit;
        } else {
                        ...
                        <form method="POST">
                            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <input type="password" name="password" id="password" minlength="8" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                </div>
