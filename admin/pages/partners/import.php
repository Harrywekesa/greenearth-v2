...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['csv_file'])) {
    if($_FILES['csv_file']['error'] === UPLOAD_ERR_OK) {
        ...
        if($handle) {
            ...
            $stmt = $connection->prepare("UPDATE partners SET historical_data = ? WHERE id = ?");
            $stmt->bind_param("si", $json_data, $partner_id);
            
            if($stmt->execute()) {
                $message = "Partner data imported successfully!";
                ...
                $error = "Error importing partner data: " . $stmt->error;
            }
        } else {
...
<head>
    ...
    <title>Import Partner Data - GreenEarth Admin</title>
            ...
            <div class="px-4 md:px-10 py-8">
                <div class="max-w-4xl mx-auto">
                    <div class="flex justify-between items-center">
                        <h1 class="text-2xl font-bold text-gray-900">Import Data for <?php echo htmlspecialchars($partner['name']); ?></h1>
                    ...
                    <div class="mt-6">
                        <div class="bg-white rounded-lg shadow p-6">
                            <h2 class="text-lg font-medium text-gray-900">Upload Partner Data</h2>
                            <div class="mt-4">
                                <p class="text-sm text-gray-500">
                                    Upload a CSV file with historical data for <?php echo htmlspecialchars($partner['name']); ?>.
                                </p>
                            </div>
                        ...
                        <div class="mt-8 bg-white rounded-lg shadow p-6">
                            ...
                            <div class="mt-4">
                                ...
                                <ul class="mt-2 list-disc list-inside text-sm text-gray-500">
                                    <li>Year (e.g., 2020, 2021)</li>
                                    <li>Month (e.g., January, February)</li>
                                    <li>Revenue (KES)</li>
                                    <li>Contributions (trees planted)</li>
                                    <li>Volunteers</li>
                                </ul>
                            </div>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        <thead class="bg-gray-50">
                                            <tr>
                                                ...
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Revenue (KES)</th>
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">January</td>
                                            ...
                                            <tr>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2020</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">February</td>
                        ...
                        <?php if($partner['historical_data']): ?>
                        <div class="mt-8 bg-white rounded-lg shadow p-6">
                            <h2 class="text-lg font-medium text-gray-900">Current Data</h2>
                            <div class="mt-4">
                                <p class="text-sm text-gray-500">
                                    This partner currently has <?php echo count(json_decode($partner['historical_data'], true)); ?> records of historical data.
                                </p>
                            </div>
